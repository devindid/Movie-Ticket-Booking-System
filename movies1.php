...
<header class="masthead">
	...
	<?php while($row=$movies->fetch_assoc()): ?>
        <div class="movie-item">
          ...
          <div class="mov-det">
            <button type="button" class="btn btn-primary" data-id="<?php echo $row['id'] ?>"><a href="login_form.php">Book Now</a></button>
          </div>
        </div>
    <?php endwhile; ?>
...
<script>
    ...
    location.replace('index1.php?page=reserve&id='+$(this).attr('data-id'))
  })
</script>