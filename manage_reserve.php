...
<div class="form-group col-md-2">
		<label for="" class="control-label">Full</label>
		<input type="number" name="full" id="full" class="form-control" min="0" required="">
	</div>
	<div class="form-group col-md-2">
		<label for="" class="control-label">Half</label>
		<input type="number" name="half" id="half" class="form-control" min="0" required="">
	</div>
	<div class="form-group col-md-4">
	...
	<div class="form-group col-md-2">
	<input type="button" class="click" onClick="multiplyBy()" Value="Check" />
			</div>
		<p>The Total price is : Rs.
                  <span id = "result"></span>.00
                  </p>      			  
	</div>
	<?php
	$sql = "INSERT INTO books (payment) VALUES ('result')";
	?>
	
<script>
function multiplyBy()
{
        num1 = document.getElementById("full").value;
        num2 = document.getElementById("half").value;
        document.getElementById("result").innerHTML = num1 * 250 + num2 * 150;
}
  </script>
